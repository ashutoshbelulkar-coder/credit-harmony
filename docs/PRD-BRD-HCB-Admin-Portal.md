...
**Date:** 2026-08-10
**Status:** Updated — **v2.18:** Traceability tab shows packets → product only (no Data submitters / Consumers columns); BRD-Product-Configurator **v1.5**. **v2.17:** Data Products authoring expansion. Earlier: v2.16–v2.0 as below.
**Classification:** Internal – Confidential

> **Change Summary v2.18 (2026-08-10) — Traceability without submitters/consumers:** Product detail **Traceability** shows **data packets → this product version** only. **Data submitters** and **Consumers** columns removed. Subscribers remain on the **Subscribers** tab. Aligns with [BRD-Product-Configurator.md](./BRD-Product-Configurator.md) v1.5.
>
