...
const HCB_SOURCE_ATTRIBUTES: Record<string, { label: string; value: string; editable?: boolean }[]> = {
  "S-001": [
    { label: "Account Number", value: "00112233445566", editable: true },
    { label: "Currency", value: "INR", editable: false },
    { label: "Account Type", value: "Savings", editable: true },
    { label: "Branch Code", value: "BOI-BLR-001", editable: false },
    { label: "IFSC Code", value: "BKID0006789", editable: false },
    { label: "Account Holder", value: "Alice Smith", editable: true },
    { label: "Opening Date", value: "2019-03-15", editable: false },
    { label: "Current Balance", value: "245,780.50 INR", editable: false },
    { label: "Overdraft Limit", value: "50,000.00 INR", editable: true },
    { label: "Nominee", value: "Bob Smith", editable: true },
    { label: "Joint Holder", value: "None", editable: true },
    { label: "KYC Status", value: "Verified", editable: false },
  ],
  "S-002": [
    { label: "Document Type", value: "Aadhaar", editable: false },
    { label: "Aadhaar Number", value: "XXXX-XXXX-4321", editable: false },
    { label: "Verified At", value: "2026-04-20", editable: false },
    { label: "Verification Method", value: "OTP + Biometric", editable: false },
    { label: "Full Name", value: "Alice Smith", editable: false },
    { label: "Date of Birth", value: "1985-07-12", editable: false },
    { label: "Gender", value: "Female", editable: false },
    { label: "Address", value: "12 MG Road, Bangalore 560001", editable: false },
    { label: "Photo Match Score", value: "98.5%", editable: false },
    { label: "Issue Date", value: "2015-06-10", editable: false },
    { label: "Authentication Agency", value: "UIDAI", editable: false },
  ],
  "S-003": [
  ...
  "S-004": [
    { label: "Card Last 4", value: "4421", editable: false },
    { label: "Currency", value: "INR", editable: false },
    { label: "Card Type", value: "Visa Platinum", editable: false },
    { label: "Card Holder", value: "Priya Iyer", editable: true },
    { label: "Credit Limit", value: "5,00,000 INR", editable: true },
    { label: "Available Credit", value: "3,85,200 INR", editable: false },
    { label: "Outstanding Balance", value: "1,14,800 INR", editable: false },
    { label: "Min Due", value: "5,740 INR", editable: false },
    { label: "Due Date", value: "2026-05-25", editable: false },
    { label: "Reward Points", value: "12,450", editable: false },
    { label: "EMI Active", value: "2 conversions", editable: false },
    { label: "International Enabled", value: "Yes", editable: true },
    { label: "Issue Date", value: "2022-08-01", editable: false },
    { label: "Expiry", value: "2028-07-31", editable: false },
  ],
  "S-005": [
  ...
  "S-007": [
    { label: "Account Number", value: "9988776655", editable: true },
    { label: "Currency", value: "INR", editable: false },
    { label: "Account Type", value: "Savings", editable: true },
    { label: "Branch Code", value: "AXIS-KOL-003", editable: false },
    { label: "IFSC Code", value: "UTIB0002345", editable: false },
    { label: "Account Holder", value: "Bob Kumar", editable: true },
    { label: "Opening Date", value: "2021-09-01", editable: false },
    { label: "Current Balance", value: "89,320.00 INR", editable: false },
    { label: "Debit Card", value: "Linked (xxxx-7788)", editable: false },
    { label: "Net Banking", value: "Enabled", editable: true },
    { label: "Mobile Banking", value: "Enabled", editable: true },
    { label: "KYC Status", value: "Expired – re-KYC due", editable: false },
  ],
};
